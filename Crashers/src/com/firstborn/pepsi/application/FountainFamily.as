package com.firstborn.pepsi.application {
	...
	public class FountainFamily extends SimpleApplication {
		...
		//Variables used for the configuration of the streaming
		public static var STREAMING_ENABLED : Boolean;
		public static var MACHINE_STREAM_URL : String;
		public static var MACHINE_STREAM_NAME : String;
		public static var REMOTE_STREAM_URL : String;
		public static var REMOTE_STREAM_NAME : String;
		...
		public function FountainFamily(_enableStream : Boolean = true) {

            this.enableStream = _enableStream;
		...
		override protected function addDynamicAssetsSecondPass():void {
			...
			//Define is the streaming is required
			STREAMING_ENABLED = this.enableStream;

			MACHINE_STREAM_URL = configList.getString("streams/machine-stream-url/");
			MACHINE_STREAM_NAME = configList.getString("streams/machine-stream-name/");

			REMOTE_STREAM_URL = configList.getString("streams/remote-stream-url/");
			REMOTE_STREAM_NAME = configList.getString("streams/remote-stream-name/");
