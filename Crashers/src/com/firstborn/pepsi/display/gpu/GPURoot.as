	...
	public class GPURoot extends Sprite {
		...
		private function hideSoftwareADAHome(__immediate:Boolean = false):void {
			...
			if (!__immediate && FountainFamily.platform.supportsLightsAPI) {
				FountainFamily.backendModel.setLightColorARGB(FountainFamily.lightingInfo.colorStandby, TIME_SOFTWARE_ADA_HIDE * 1000, FountainFamily.lightingInfo.brightnessScale);
			}
		...
		private function redrawBrandViewVisibility():void {
			...
			if (buttonSoftwareADA != null) buttonSoftwareADA.visibility = homeView.uiVisibility;
