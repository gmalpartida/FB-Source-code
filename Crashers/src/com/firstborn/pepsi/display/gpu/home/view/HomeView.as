package com.firstborn.pepsi.display.gpu.home.view {
	...
	public class HomeView extends Sprite {
		...
		private var _languageSignal : SimpleSignal;

		public static var GPUParent : GPURoot;
		...
		public function HomeView(__options:HomeViewOptions, __forceDisallowKeyboardFocus:Boolean = false, __currentLanguage : uint = 1) {
			...
			isPaused = false;
			options = __options;
			_languageSignal = new SimpleSignal();
		...
		private function redrawVisibility():void {
			...
			if (buttonPourSparklingWater != null) buttonPourSparklingWater.visibility = _uiVisibility;
...
//		}
		...
		public function onPreShow():void {
			...
			if (FountainFamily.platform.supportsLightsAPI) {
				FountainFamily.backendModel.setLightColorARGB(FountainFamily.lightingInfo.colorStandby, FountainFamily.lightingInfo.timeColorChange * 1000, FountainFamily.lightingInfo.brightnessScale);
			}
		}
		...
		public function get languageSignal() : SimpleSignal {
			return _languageSignal;
		}
