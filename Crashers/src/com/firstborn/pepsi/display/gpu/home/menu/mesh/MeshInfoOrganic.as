package com.firstborn.pepsi.display.gpu.home.menu.mesh {
	...
	public class MeshInfoOrganic extends MeshInfo {
		...
		override protected function setDefaultValues():void {
			...
			bottommostRowUsed = -1;
			paddingTop = 0;
			paddingBottom = MathUtils.map(_numNodes, 8, 12, 0, -20, true);
			paddingLeft = MathUtils.map(_numNodes, 8, 12, 0, -20, true);
			paddingRight = MathUtils.map(_numNodes, 8, 12, 0, -20, true);
