package com.firstborn.pepsi.display.gpu.brand.flavors.mixes {
	...
	public class FlavorMixView extends Sprite {
		...
		private function createElements():void {
			...
			var fontName:String = _fontType == BrandViewOptions.FONT_TYPE_REGULAR ? FontLibrary.BOOSTER_FY_REGULAR : FontLibrary.BOOSTER_NEXT_FY_LIGHT;
            ...
            //Hacking time... To avoid rendering flavors in the bobcat implementation
            var maxFlavors : int = FountainFamily.platform.id == "bobcat" ? 0 : flavorIds.length;

			for (var i:int = 0; i < maxFlavors; i++) {
