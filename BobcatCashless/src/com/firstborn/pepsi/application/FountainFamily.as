...
import com.firstborn.pepsi.data.LightingInfo;
	...
	public class FountainFamily extends SimpleApplication {
        ...
        //For the payment
        public static var PAYMENT_ENABLED : Boolean = false;                                                    //Variable that defined if the machine will ask for a payment on selected beverages
        public static var PAYMENT_AMOUNT : String = "0.50$";                                                    //String that defines the amount of money charged for selected beverages
		...
		override protected function createVisualAssets():void {
            ...
            //For the payment
            PAYMENT_ENABLED                                 = configList.getBoolean("payment/payment-enabled")  || false;
            PAYMENT_AMOUNT                                  = configList.getString("payment/payment-amount")  || "0.50$";
