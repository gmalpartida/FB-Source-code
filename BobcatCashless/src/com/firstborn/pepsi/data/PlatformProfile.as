...
import com.zehfernando.utils.XMLUtils;
	...
	public class PlatformProfile {
        ...
        public static const BUBBLE_SHAPE_DEFAULT : String = "default";
        public static const BUBBLE_SHAPE_CIRCLE : String = "circle";
        ...
        public var mainColorInterface : uint;
		...
		public function PlatformProfile() {
            ...
            backgroundImage = "";
            mainColorInterface = 0x3da5e7;
            bubbleShape = BUBBLE_SHAPE_DEFAULT;
		...
		public static function fromXMLList(__xmlList:XMLList, __id:String):PlatformProfile {
			...
			for (i = 0; i < __xmlList.length(); i++) {
				...
				if (XMLUtils.getAttributeAsString(profileXML, "id") == __id) {
                    ...
                    newProfile.backgroundImage                  = XMLUtils.getNodeAsString(profileXML,	    "backgroundImage",		            newProfile.backgroundImage);
                    newProfile.mainColorInterface               = getUintFromColorString(XMLUtils.getFilteredNodeAsString(profileXML, "mainColorInterface", [], []), newProfile.mainColorInterface);
                    newProfile.bubbleShape						= XMLUtils.getNodeAsString(profileXML,		"bubbleType",						newProfile.bubbleShape);
