		...
		public static function fromXMLListItem(__xmlList:XMLList, __inventory:Inventory, __platformsIdsAllowed:Vector.<String>, __id:String):Beverage {
			...
			for (i = 0; i < __xmlList.length(); i++) {
				...
				if (XMLUtils.getAttributeAsString(beverageXML, "id") == __id) {
					...
					newBeverage.requiresPayment		    = XMLUtils.getFilteredNodeAsBoolean(beverageXML, "requiresPayment",										filterNames, filterValues, true, true, newBeverage.requiresPayment);
                    ...
                    newBeverage._design.requiresPayment = newBeverage.requiresPayment;
