...
import com.zehfernando.data.types.Color;
	...
	public class BeverageDesign {
        ...
        public var requiresPayment : Boolean;

        //For the Free copy in the Cashless version
        public var freePaymentCopyRadius : Number;
        public var freePaymentCopyColor : uint;
		...
		public function BeverageDesign() {
            ...
            freePaymentCopyRadius = 0.75;
            freePaymentCopyColor = 0xffffff;
		...
		public static function fromXML(__xmlData:XML, __platformsIdsAllowed:Vector.<String>, __adaFilter:Boolean, __isTemplate:Boolean = false, __base:BeverageDesign = null):BeverageDesign {
            ...
            //For the radius of the "Free" copy in the beverages that are free
            beverageDesign.freePaymentCopyRadius		= XMLUtils.getFilteredNodeAsFloat(__xmlData, "freePaymentCopyRadius", filterNames, filterValues, true, true, beverageDesign.scaleLogoBrand);
            beverageDesign.freePaymentCopyColor		    = getUintFromColorString(XMLUtils.getFilteredNodeAsString(__xmlData, "freePaymentCopyColor", filterNames, filterValues), beverageDesign.freePaymentCopyColor);
