...
//		private static const _CALL_SYSTEM_STATUS_REQUEST_VERSION : String = "SystemStatus.OnRequestVersion";
        ...
        //For the payment events (Bobcat Cashless), do not change
        public static const BACKEND_EVENT_PAYMENT_AUTHORIZE 				:String = "AuthenticationPending";
        public static const BACKEND_EVENT_PAYMENT_SUCCESS 				    :String = "AuthenticationSuccess";
        public static const BACKEND_EVENT_PAYMENT_ERROR 				    :String = "AuthenticationFailure";
        public static const BACKEND_COMMAND_SESSION_END 				    :String = "EndSession";
        private static var PAYMENT_READY : Boolean = false;
        ...
        public static const EVENT_PAYMENT_POUR_COMPLETE                     :String = "BackendModel.onPaymentPourComplete";


        //Events for the backend payment methods fired
        public static const EVENT_PAYMENT_AUTHORIZE							:String = "BackendModel.onPaymentAuthorize";
        public static const EVENT_PAYMENT_SUCCESS					        :String = "BackendModel.onPaymentSuccess";
        public static const EVENT_PAYMENT_ERROR					    	    :String = "BackendModel.onPaymentError";
        ...
        //Timing values for the pouring on payment
        public static var POURING_TIME_SECONDS : Number;
        public static var POURING_REMAINING_TIME_SECONDS : Number;
		...
		public static function init(__backendInterface:IBackendInterface):void {
			...
			if (backendInterface.available) {
                ...
                //for Bobcat Cashless
                backendInterface.addCallback(BACKEND_EVENT_PAYMENT_AUTHORIZE,					onPaymentAuthorize);
                backendInterface.addCallback(BACKEND_EVENT_PAYMENT_SUCCESS,						onPaymentSuccess);
                backendInterface.addCallback(BACKEND_EVENT_PAYMENT_ERROR,						onPaymentError);
			}
        ...
        private static function onPaymentAuthorize(...__args) : void {
            dispatchEvents(new Event(EVENT_PAYMENT_AUTHORIZE));
        }

        private static function onPaymentSuccess(...__args) : void {
            PAYMENT_READY = true;
            POURING_TIME_SECONDS = __args[0] != null ? Number(__args[0]) : 1;
            POURING_REMAINING_TIME_SECONDS = __args[1] != null ? Number(__args[1]) : 1;
            dispatchEvents(new Event(EVENT_PAYMENT_SUCCESS));
        }

        private static function onPaymentError(...__args) : void {
            dispatchEvents(new Event(EVENT_PAYMENT_ERROR));
        }
        ...
        //Function used for the Cashless project.
        public function paymentPourCompleted() : void {
            PAYMENT_READY = false;
            stopPour();
            sendCommand(BACKEND_COMMAND_BEVERAGE_STOP);
            sendCommand(BACKEND_COMMAND_SESSION_END);
            BackendModel.dispatchEvents(new Event(EVENT_PAYMENT_POUR_COMPLETE));
        }
