package com.firstborn.pepsi.data {
	...
	public class AttractorController {
		...
		public function AttractorController(__backendModel:BackendModel, __stage:Stage) {
            ...
            backendModel.addEventListener(BackendModel.EVENT_UNLOCKED_SESSION_FINISH, function() : void {
                goToIdleState();
            });
		}
		...
		private function onEnterFrame(__e:Event):void {
            ...
            if(!BackendModel.UNLOCK_SUCCESS_STATE && !BackendModel.UNLOCK_PROCESSING_STATE) {
                //log ("checking...",_isInIdleState,_currentMaximumIdleTime, __currentTimeSeconds, _lastInteractionTime);
                if (!_isInIdleState && _canGoToIdleState && !backendModel.isOutOfOrder && !backendModel.isPouringAnything()) {
        ...
        public function get isOnIdleSTate() : Boolean {
