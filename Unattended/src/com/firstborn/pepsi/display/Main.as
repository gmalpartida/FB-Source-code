...
import starling.core.Starling;
	...
	public class Main extends flash.display.Sprite {
		...
		private function hideGPURoot():void {
            ...
            BackendModel.APPLY_DELAY = true;
			gpuRoot.touchable = false;

            if(FountainFamily.SHOW_UNLOCK_THANKS_MESSAGE) gpuRoot.showUnlockThanks();

            //Gives enough time to show the thanks in the GPURoot.
            setTimeout(function() : void {

                FountainFamily.SHOW_UNLOCK_THANKS_MESSAGE = false;
            ...
            }, FountainFamily.SHOW_UNLOCK_THANKS_MESSAGE ? 3000 : 0);
		}

		private function showGPURoot():void {

            gpuRoot.hideUnlockThanks();
...
//				_wasFocusControllerUsed = false;
		...
		private function onAttractorVideoShown():void {
            ...
            BackendModel.APPLY_DELAY = false;
		...
		public function init():void {
            ...
            //For unattended
            FountainFamily.backendModel.addEventListener(BackendModel.EVENT_UNLOCKED_AUTHORIZE, function() : void {
                FountainFamily.attractorController.leaveIdleState();
            })
		}
