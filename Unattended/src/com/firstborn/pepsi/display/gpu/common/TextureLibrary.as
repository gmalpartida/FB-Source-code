...
import starling.textures.Texture;
	...
	public class TextureLibrary extends EventDispatcher {
        ...
        //Texture for the animation of the Spire logo in the locked menu view
        private var _textureSpireLockedMenu : Texture;
        ...
        private function createTextureSpireLockedMenu() : void {
            if(FountainFamily.LOCKED_MODE) {
                var loader:Loader = new Loader();

                loader.contentLoaderInfo.addEventListener(Event.COMPLETE, function(e : Event) : void {
                    _textureSpireLockedMenu = Texture.fromBitmap(Bitmap(LoaderInfo(e.target).content));
                });
                ...
                loader.load(new URLRequest("./assets/animations/unattended/spireSpriteSheet.png"));
            }
        }
		...
		public function init():void {
            ...
            //Load the spire animation for the unattended locked menu view
            createTextureSpireLockedMenu();
		...
		public function dispose():void {
            ...
            _textureSpireLockedMenu.dispose();
            _textureSpireLockedMenu = null;
...
//		}
        ...
        public function getSpireLockedMenuViewTexture():Texture {
            return _textureSpireLockedMenu;
        }
