package com.zehfernando.transitions {
	...
	public class ZTween {
		...
		*/
		...
		protected static var _timeScale:Number;
...
//		protected static var tt:Vector.<ZTween>;											// Temp tween list
		...
		protected static function init():void {
			...
			currentTimeFrame = 0;
			currentTime = getTimerUInt() * _timeScale;
		}
		...
		/**
		 * Gets the current time in ms. getTimer() is an int that has a max value of ~596 hours; this one runs for ~1192 hours
		 */
		protected static function getTimerUInt():uint {
			v = getTimer();
		...
		*/
		...
		public static function getNumTweens():uint {
		...
		*/
		...
		public static function set timeScale(__value:Number):void {
			if (_timeScale != __value) {
				var oldTime:Number = currentTime / _timeScale;
				_timeScale = __value;
				currentTime = oldTime * _timeScale;
			}
		}
	}
}
