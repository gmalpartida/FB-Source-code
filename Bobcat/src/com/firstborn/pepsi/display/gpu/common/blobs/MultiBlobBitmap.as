package com.firstborn.pepsi.display.gpu.common.blobs {
	...
	public class MultiBlobBitmap extends TiledBitmapData {
		...
		public function addBlob(__colorSolid:uint, __alphaSolid:Number, __colorStroke:uint, __alphaStroke:Number, __strokeWidth:Number = 2, __noiseRadiusScale:Number = 1, __isInverse:Boolean = false, __filters:Array = null, __variableOctables:Boolean = false, __normalizeRadius:Boolean = false, __randomSeed:int = -1):void {
			...
			var shape:BlobShape = new BlobShape(r, __colorSolid, __alphaSolid, __colorStroke, __alphaStroke, __strokeWidth, BlobShape.NOISE_RADIUS_SCALE_STANDARD * __noiseRadiusScale, octavesA, octavesB, __normalizeRadius, __randomSeed);
